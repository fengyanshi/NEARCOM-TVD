...
!    are shared.                                                           40.22
!
!     SPCSIG_f90: Contains discretisec values for sigma. Second dimension indicates
!                 power of sigma.
!
...
!     MXMIP   : maximum number of output location points
!     MXOURQ  : maximum number of output requests
...
!MPI!DOS
!MPI!DOS      MODULE MPI
!MPI!DOS      INCLUDE 'mpif.h'
!MPI!DOS      END MODULE MPI
